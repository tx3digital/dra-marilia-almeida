...
const AboutSection: React.FC = () => {
  return (
    <section className="py-12 bg-[#f7f5f3] relative overflow-hidden" id="sobre">
      <div className="absolute top-20 left-4 text-[6rem] md:text-[8rem] font-black text-[#a89b92] opacity-[0.02] md:opacity-[0.03] select-none pointer-events-none whitespace-nowrap tracking-tighter uppercase">
        Marília Almeida
      </div>
