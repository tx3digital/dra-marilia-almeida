...
const SpecialtiesGrid: React.FC = () => {
  return (
    <section className="py-12 bg-[#f7f5f3]" id="especialidades">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <span className="text-[#833c4e] font-extrabold uppercase tracking-[0.5em] text-[10px] mb-4 block">Foco Clínico</span>
        <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-8 tracking-tight uppercase">Especialidades</h2>
